...
public class JSON_Class implements Serializable{
    ...
    public static void getJSON(String path,String outputDir) {
        ...
        for (Map.Entry<String, Map> entry : schema.entrySet()) {
            ...
            newObject = true;
            createTestCases(jo,link,outputDir);
//            count++;
//            if(count==2) {
//                break;
//            }
    ...
    private static void createTestCases(LinkedHashMap jo, String link,String outputDir){
        String separator = System.getProperty("file.separator");
        String path = System.getProperty("user.dir")+separator+"conf"+separator+"testJSON"+separator+"testCase2.json";
    ...
    private static void writeJSON(LinkedHashMap obj,String link,JSONArray combination,String outputDir){
        ...
        File fileName = new File(outputDir+separator+link+".json");
        ...
        try {
            ...
            System.out.println("error : Filenotfound in writeJSON"+e);
        }
        catch (IOException e){
            System.out.println("error : IOException in writeJSON");
        }

        //System.out.println("Going to the end");
    }
}
